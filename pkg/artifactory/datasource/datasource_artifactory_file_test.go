...
func TestDownloadFile(t *testing.T) {
	...
	var downloadCheck = func(state *terraform.State) error {
		...
		verified,founded_hash,cmd_hash,zipinfo, err := datasource.VerifySha256Checksum(download, "7a2489dd209d0acb72f7f11d171b418e65648b9cc96c6c351e00e22551fdd8f1")
		if !verified {
...
func TestDownloadFileWith_path_is_aliased(t *testing.T) {
	...
	var downloadCheck = func(state *terraform.State) error {
		...
		verified,founded_hash,cmd_hash,zipinfo, err := datasource.VerifySha256Checksum(download, "fb59a2bb4698ed7ea025ea055e5dc1266ea2e669dd689765ebf26bcb7c94a230")
		if !verified {
...
func TestDownloadFileVerifySha256Checksum(t *testing.T) {
	...
	sha256Verified, founded_hash,cmd_hash,zipinfo,err := datasource.VerifySha256Checksum(filePath, expectedSha256)
